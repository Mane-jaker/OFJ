...
### branch-pr
- Path: /home/mane/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/mane/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/mane/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/mane/.config/opencode/skills/comment-writer/SKILL.md
...
### find-skills
- Path: /home/mane/.agents/skills/find-skills/SKILL.md
...
### go-testing
- Path: /home/mane/.config/opencode/skills/go-testing/SKILL.md
...
### insforge
- Path: /home/mane/.agents/skills/insforge/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### insforge-cli
- Path: /home/mane/.agents/skills/insforge-cli/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### insforge-debug
- Path: /home/mane/.agents/skills/insforge-debug/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### insforge-integrations
- Path: /home/mane/.agents/skills/insforge-integrations/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /home/mane/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/mane/.config/opencode/skills/judgment-day/SKILL.md
...
### skill-creator
- Path: /home/mane/.agents/skills/skill-creator/SKILL.md
...
### work-unit-commits
- Path: /home/mane/.config/opencode/skills/work-unit-commits/SKILL.md
